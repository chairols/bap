        ...
        <div class="card">
            <div class="body people-list">
                ...
                <ul class="nav nav-tabs p-l-0 p-r-0" role="tablist">
                    <li class="nav-item inlineblock"><a class="nav-link active" data-toggle="tab" href="#people">Personas</a></li>
                    <li class="nav-item inlineblock"><a class="nav-link" data-toggle="tab" href="#groups">Grupos</a></li>
                </ul>
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane slideRight active" id="people">
                        <ul class="chat-list list-unstyled m-b-0">
                            <li class="clearfix">
                                <img src="/assets/oreoadmin-140/html-light/assets/images/xs/avatar1.jpg" alt="avatar">
                                <div class="about">
