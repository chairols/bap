...
<meta charset="utf-8">
    ...
    <link rel="stylesheet" href="/assets/oreoadmin-140/html-light/assets/css/authentication.css">
    ...
    <div class="container">        
        ...
        <div class="navbar-collapse">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-white btn-round" href="javascript:void(0);">SIGN UP</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="page-header">
    <div class="page-header-image" style="background-image:url(/assets/oreoadmin-140/html-light/assets/images/login.jpg)"></div>
    <div class="container">
                ...
                <form class="form" method="POST">
                    <div class="header">
                        <div class="logo-container">
                            <img src="/assets/oreoadmin-140/html-light/assets/images/logo.svg" alt="">
                        </div>
                        <h5>Log in</h5>
                    </div>
                    <div class="content">                                                
                    ...
                    <div class="footer text-center">
                        ...
                        <h5><a href="javascript:void(0);" class="link">Forgot Password?</a></h5>
                    </div>
                </form>
            </div>
        </div>
...
<!-- Jquery Core Js -->
<script src="/assets/oreoadmin-140/html-light/assets/bundles/libscripts.bundle.js"></script>
<script src="/assets/oreoadmin-140/html-light/assets/bundles/vendorscripts.bundle.js"></script> <!-- Lib Scripts Plugin Js -->
